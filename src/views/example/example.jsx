...
import {saveFormData, saveImg, clearData} from "@/store/example/action";
// import "./home.css";
...
class Home extends Component {
   ...
   */
    ...
    sumitForm = () => {
        ...
        this.setState({alertStatus: true, alertTip});
    };
    ...
    render() {
        return (
            <main className="home-container">
                <p className="common-title">请.录入您的信息</p>
